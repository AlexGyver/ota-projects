...
- Для добавления поддержки своего проекта нужно создать репозиторий, в корне которого в ветке *main* должен находиться файл *project.json* с информацией о проекте и ссылкой на скомпилированную прошивку. Правила оформления файла можно посмотреть например [здесь](https://github.com/GyverLibs/AutoOTA?tab=readme-ov-file#%D1%84%D0%B0%D0%B9%D0%BB-projectjson)
`);
