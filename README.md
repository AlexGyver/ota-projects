...
> [!WARNING]
> Бинарник из релизов на данный момент не работает
...
Также можно объединить файлы в программе ESP Flash Tool и указать `"offset": 0` у общего бинарника в манифесте:

![combine](docs/combine.jpg)
